...
- Сделать макросы для очень быстрого накидывания значений движения, то есть сократить количество параметров до только
градусов, но оставить возможность регулировать все остальное
- Добится максимально точного движения робота по градусам
*/
void stopBC()
{
