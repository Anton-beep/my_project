...
TODO:
- smart accels
- одна удобная функция чтобы контроллировать до какого момента роботу делать какое-то действие: ехать вперед пока 
белый, двигаться по линии до черного и т.д.
