...
void defineForLogic()
{
    ...
    GREEN_CUBE_FIRST_SCAN.H = 128.2;
    GREEN_CUBE_FIRST_SCAN.S = 75.3;
    GREEN_CUBE_FIRST_SCAN.V = 20;

    BLUE_CUBE_FIRST_SCAN.H = 216;
    BLUE_CUBE_FIRST_SCAN.S = 81.7;
    BLUE_CUBE_FIRST_SCAN.V = 20;
