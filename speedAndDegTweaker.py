...
# speeds and accels
SAFE_START_ACCEL = 15  # deg * s ** -2
SAFE_END_ACCEL = 7  # deg * s ** -2
SAFE_START_SPEED = 17  # deg * s ** -1
SAFE_MAX_SPEED = 95  # deg * s ** -1
SAFE_END_SPEED = 16  # deg * s ** -1
